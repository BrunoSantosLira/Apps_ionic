...
function addNxToNest(options, packageJson) {
    var _a, _b, _c, _d;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const scripts = Object.keys((_a = packageJson.scripts) !== null && _a !== void 0 ? _a : {}).filter((s) => {
        ...
        if (options.interactive) {
            ...
            useNxCloud = (_d = options.nxCloud) !== null && _d !== void 0 ? _d : false;
        }
