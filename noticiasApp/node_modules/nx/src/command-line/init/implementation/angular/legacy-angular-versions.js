...
function getLegacyMigrationFunctionIfApplicable(repoRoot, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield installDependencies(repoRoot, {
                pkgName,
                pkgScope,
                pkgVersion,
                unscopedPkgName,
...
function installDependencies(repoRoot, pkgInfo, useNxCloud, pmc) {
    var _a, _b;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (useNxCloud) {
            ...
            json.devDependencies['nx-cloud'] = yield resolvePackageVersion('nx-cloud', `^${(0, semver_1.major)(pkgInfo.pkgVersion)}.0.0`);
        }
