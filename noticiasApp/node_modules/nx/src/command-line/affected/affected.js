...
function affected(command, args, extraTargetDependencies = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { nxArgs, overrides } = (0, command_line_utils_2.splitArgsIntoNxArgsAndOverrides)(args, 'affected', {
        ...
        const projects = yield projectsToRun(nxArgs, projectGraph);
        try {
            switch (command) {
                case 'graph':
                ...
                case 'affected': {
                    ...
                    if (nxArgs.graph) {
                        ...
                        return yield (0, graph_1.generateGraph)({
                            watch: false,
                            open: true,
                            view: 'tasks',
...
function projectsToRun(nxArgs, projectGraph) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        let affectedGraph = nxArgs.all
            ? projectGraph
            : yield (0, affected_project_graph_1.filterAffected)(projectGraph, (0, file_utils_1.calculateFileChanges)((0, command_line_utils_2.parseFiles)(nxArgs).files, projectGraph.allWorkspaceFiles, nxArgs));
        if (nxArgs.exclude) {
