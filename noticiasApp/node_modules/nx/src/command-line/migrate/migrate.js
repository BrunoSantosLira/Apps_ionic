        ...
        try {
            ...
            try {
                if (['nx', '@nrwl/workspace'].includes(opts.targetPackage) &&
                    ...
                    const useCloud = yield (0, connect_to_nx_cloud_1.connectToNxCloudCommand)(ab_testing_1.messages.getPromptMessage('nxCloudMigration'));
            ...
            const { migrations, packageUpdates, minVersionWithSkippedUpdates } = yield migrator.migrate(opts.targetPackage, opts.targetVersion);
...
function runNxMigration(root, collectionPath, collection, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const host = new tree_1.FsTree(root, process.env.NX_VERBOSE_LOGGING === 'true');
        yield fn(host, {});
        host.lock();
