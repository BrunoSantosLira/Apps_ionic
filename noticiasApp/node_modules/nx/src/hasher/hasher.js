...
exports.filterUsingGlobPatterns = exports.expandNamedInput = exports.splitInputsIntoSelfAndDependencies = exports.extractPatternsFromFileSets = exports.getTargetInputs = exports.getNamedInputs = exports.Hasher = void 0;
...
class Hasher {
    constructor(projectGraph, nxJson, options, hashing = undefined) {
        ...
        this.taskHasher = new TaskHasher(nxJson, legacyRuntimeInputs, legacyFilesetInputs, this.projectGraph, this.hashing, { selectivelyHashTsConfig: (_a = this.options.selectivelyHashTsConfig) !== null && _a !== void 0 ? _a : false });
    }
    hashTask(task) {
...
class TaskHasher {
    constructor(nxJson, legacyRuntimeInputs, legacyFilesetInputs, projectGraph, hashing, options) {
        this.nxJson = nxJson;
    ...
    hashTask(task, visited) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return Promise.resolve().then(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const { selfInputs, depsInputs, projectInputs } = splitInputsIntoSelfAndDependencies(targetData.inputs ||
                    (targetDefaults === null || targetDefaults === void 0 ? void 0 : targetDefaults.inputs) ||
                    DEFAULT_INPUTS, namedInputs);
                const selfAndInputs = yield this.hashSelfAndDepsInputs(task.target.project, selfInputs, depsInputs, projectInputs, visited);
    ...
    hashNamedInputForDependencies(projectName, namedInput, visited) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    hashSelfAndDepsInputs(projectName, selfInputs, depsInputs, projectInputs, visited) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    hashExternalDependency(projectName, visited = new Set()) {
        ...
        if (node) {
            ...
            partialHash = {
                ...
                details: Object.assign({ [projectName]: hash }, partialHashes.reduce((m, c) => (Object.assign(Object.assign({}, m), c.details)), {})),
            };
        }
        else {
            // unknown dependency
    ...
    hashTarget(projectName, targetName, selfInputs) {
        ...
        if (hasCommandExternalDependencies) {
            return {
                ...
                details: partialHashes.reduce((acc, c) => (Object.assign(Object.assign({}, acc), c.details)), {}),
            };
        }
