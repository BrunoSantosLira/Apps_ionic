    ...
    queue.sendToQueue(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(exports.registeredFileWatcherSockets.map(({ socket, config }) => {
            ...
            if (config.watchProjects === 'all') {
                ...
                const watchedProjects = new Set((0, find_matching_projects_1.findMatchingProjects)(config.watchProjects, project_graph_incremental_recomputation_1.currentProjectGraphCache.nodes));
